...
admin.site.site_header = "Repay"
admin.site.site_title = "Repay Admin Portal"
admin.site.index_title = "Repay Admin"

# swagger
api_info = openapi.Info(
    title="Repay API",
    default_version="v1",
    description="API documentation for Repay App",
)
